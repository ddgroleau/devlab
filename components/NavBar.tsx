...
const NavBar = () => {
    ...
    return (
        <nav className={classNames(
            ...
            <button className="flex w-[40px] h-[40px] absolute right-8 top-8 lg:hidden"
                onClick={toggleMobileNav}>
                <div  className={classNames(
                    "inline-block h-[4px] w-[40px] bg-primary dark:bg-dark-primary transition translate-y-[8px]",
                    ...
                    conditional(
                        navIsOpen,
                        "h-0 after:rotate-45 after:translate-y-[-1px] before:-rotate-45 before:translate-y-[2px]"
                    )
                )}>
